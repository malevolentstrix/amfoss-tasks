...
public class MathQuiz extends JFrame {
    ...
    class startListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (operator == 1) {
                ...
                temp = num1*1.0 / num2;//formula
                	DecimalFormat df = new DecimalFormat("###.###");
                result=Double.parseDouble(df.format(temp));
                question = ("" + num1 + "/" + num2); //question label content
            } else {
                result = num1 + num2; //formula 
                question = ("" + num1 + "+" + num2); //question label content
    ...
    class stopListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            double realTime = timeSpent / 1000.0; // converting to readible time (because it is miliseconds)
            String stringtimeSpent = Double.toString(realTime); // converting float to string
